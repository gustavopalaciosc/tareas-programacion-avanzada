...
class Usuario:
    ...
    def escuchar_canciones(self, nombre_lista):
        # Deben completar
        for cancion in self.listas_reproduccion[nombre_lista]:
            cancion.reproducir()
            like = self.calificar_cancion(cancion)
            yield like, cancion.rankings
        print("Hemos llegado al final de la lista de reproduccion")
