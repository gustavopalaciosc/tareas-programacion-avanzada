...
class DCCubitos(QApplication):
    ...
    def conectar_inicio(self):
        # COMPLETAR
        self.ventana_inicio.senal_enviar_login.connect(self.logica_inicio.comprobar_usuario)
    ...
    def conectar_juego(self):
        ...
        self.logica_juego.senal_mover_plataforma.connect(self.ventana_juego.mover_plataforma)
