...
class Simulacion:
    ...
    def nuevo_dia(self) -> None:
        # Completar
        recolector1 = Recolector(nombre = "Fulanito", centro_urbano = self.centro_urbano)
        recolector2 = Recolector(nombre = "Pepito", centro_urbano = self.centro_urbano)
        constructor1 = Constructor(nombre = "Isabel II", centro_urbano = self.centro_urbano)
        constructor2 = Constructor(nombre = "Bob", centro_urbano = self.centro_urbano)
        recolector1.start()
        recolector2.start()
        constructor1.start()
        constructor2.start()
