...
INTERVALO_APARICION_SOLES = 25000
...
PATH_ZOMBIES = path.join("frontend","assets", "sprites", "Zombies")
PATH_PLANTAS = path.join("frontend","assets", "sprites", "Plantas")
PATH_ELEMENTOS_JUEGO = path.join("frontend", "assets", "sprites", "Elementos de juego")